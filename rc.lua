...
globalkeys = gears.table.join(
	...
	awful.key({ "Control", "Shift" }, "Right", function() awful.spawn("brightnessctl set +10%") end,
		{ description = "Brigntess up", group = "layout" }),
	awful.key({ "Control", "Shift" }, "Left", function() awful.spawn("brightnessctl set 10%-") end,
		{ description = "Brigntess down", group = "layout" }),
